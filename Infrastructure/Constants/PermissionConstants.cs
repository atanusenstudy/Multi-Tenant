namespace Infrastructure.Constants
{
    ...
    //Records are Immutable by Default and compare values bsed on values
    public record SchoolPermission(string Action, string Feature, string Description, string Group,
    ...
    public static class SchoolPermissions
    {
        ...
        [
            // For Super-User for Subscription Management
            ...
            new SchoolPermission(SchoolAction.UpgradeSubscription, SchoolFeature.Tenants, "Upgdate Tenant's Subscription", "Tenancy", IsRoot: true),

            // Identeties management for Users management
